  ...
  <fieldset class='fieldset_basic'>
    <UL>
      <c:choose>
        ...
        <c:when test="${code == 'like_success'}"> <%-- Java if --%>
          <li class='li_none'>
            <span class="span_success">즐겨찾기 등록에 성공했습니다.</span>
          </li> 
        </c:when>
        
        <c:when test="${code == 'unlike_success'}"> <%-- Java if --%>
          <li class='li_none'>
            <span class="span_success">즐겨찾기 해제에 성공했습니다.</span>
          </li> 
        </c:when>
        ...
        <c:when test="${code == 'like_fail'}"> <%-- Java if --%>
          <LI class='li_none'>
            <span class="span_fail">즐겨찾기 등록에 실패했습니다.</span>
          </LI>                                                                      
        </c:when>
        
        <c:when test="${code == 'unlike_fail'}"> <%-- Java if --%>
          <LI class='li_none'>
            <span class="span_fail">즐겨찾기 해제에 실패했습니다.</span>
          </LI>                                                                      
        </c:when>
      ...
      <li class='li_none'>
        ...
        <button type='button' onclick="location.href='../notices/list_by_search.do?now_page=1'" class="btn btn-secondary btn-sm">목록</button>
      </li>
    </UL>
  </fieldset>
