    ...
    <table class="table table-striped" style='width: 100%;'>
      ...
      <tbody>
        <c:forEach var="replyMemberVO" items="${list }">
          ...
          <c:set var="bulletinidx" value="${replyMemberVO.bulletinidx }" />
          <c:set var="memberno" value="${replyMemberVO.memberno }" />
          <c:set var="id" value="${replyMemberVO.id }" />
          <c:set var="replytext" value="${replyMemberVO.replytext }" />
          ...
          <tr style='height: 50px;'> 
            ...
            <td style='text-align: center; vertical-align: middle;'>
              <A href='../contents/read.do?contentsno=${bulletinidx }'>${bulletinidx}</A>
            </td>
            <td style='text-align: center; vertical-align: middle;'>
              <A href='../member/read.do?memberno=${memberno }'>${id}</A>
            </td>
            <td style='text-align: left; vertical-align: middle;'>${replytext}</td>
            <td style='text-align: center; vertical-align: middle;'>
